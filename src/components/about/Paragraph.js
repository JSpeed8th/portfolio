...
const Paragraph = () => {
	return (
		<p>
			...
			I love to travel, hence the beautiful photographs taken by my fiance during our time in Iceland. 
			I'm a naturists through and through and try to live as organic and wastless as possible.
        </p>
		)
};
